...
public final class CoreBankingSQLStatementConstant {
    ...
    public static final String CUSTOMER_INSERT = "INSERT INTO customer_info (customer_name, gender, date_of_birth) " +
            "VALUES (customer_name = #{customer_name}, gender = #{gender}, date_of_birth = #{date_of_birth})";
    ...
    public static final String CUSTOMER_LIMIT_INSERT = "INSERT INTO customer_limit (customer_id, limit_type, limit_category, original_limit, current_limit, " +
            "control_limit_id, create_time, update_time) VALUES (customer_id = #{customer_id}, limit_type = #{limit_type}, limit_category = #{limit_category}, " +
            "original_limit = #{original_limit}, current_limit = #{current_limit}, control_limit_id = #{control_limit_id}, create_time = #{create_time}, " +
